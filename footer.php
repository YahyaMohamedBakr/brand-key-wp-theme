 ...
 * Uses inline SVGs (matching the static HTML theme exactly)
 *
 * @package BrandKey
 */
?>
			...
			<div class="footer-container">
				<div class="footer-grid">
					...
					<div class="footer-col footer-col--about" data-col="0">
						...
						<p class="footer-desc">
							<?php echo esc_html( get_theme_mod( 'brandkey_about_text', 'شركة متخصصة في التسويق الرقمي وخدمات التكنولوجيا، أسست في عام 2011. نسعى دائماً لتقديم حلول مبتكرة تساعد عملائنا على النمو والنجاح.' ) ); ?>
						</p>
						<div class="footer-social">
							<a href="<?php echo esc_url( get_theme_mod( 'brandkey_facebook', '#' ) ); ?>" class="social-link" aria-label="Facebook" target="_blank" rel="noopener">
							...
							<a href="<?php echo esc_url( get_theme_mod( 'brandkey_instagram', '#' ) ); ?>" class="social-link" aria-label="Instagram" target="_blank" rel="noopener">
							...
							<a href="<?php echo esc_url( get_theme_mod( 'brandkey_linkedin', '#' ) ); ?>" class="social-link" aria-label="LinkedIn" target="_blank" rel="noopener">
								<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true"><path d="M4.5 1.5C4.5 2.33 3.83 3 3 3C2.17 3 1.5 2.33 1.5 1.5C1.5 0.67 2.17 0 3 0C3.83 0 4.5 0.67 4.5 1.5ZM0.5 5H3.5V17H0.5V5ZM7.5 5H12.3V7.1H12.37C13 5.5 14.35 4.75 16.5 4.75C21 4.75 21.5 7.5 21.5 11V17H16.5V11C13 11 11.5 9.2 11.5 11V17H7.5V5Z" fill="currentColor"/></svg>
							</a>
							<a href="<?php echo esc_url( get_theme_mod( 'brandkey_twitter', '#' ) ); ?>" class="social-link" aria-label="X (Twitter)" target="_blank" rel="noopener">
