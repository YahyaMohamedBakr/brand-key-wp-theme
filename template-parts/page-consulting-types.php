<?php
/**
 * سيكشن: types (consulting)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'consulting', 'types' ) ) return;

$title = bk_section( 'consulting', 'types', 'title' );
$desc = bk_section( 'consulting', 'types', 'desc' );
$heading = bk_section( 'consulting', 'types', 'heading' ) ?: 'h2';
$bg = bk_section( 'consulting', 'types', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'consulting', 'types', 'btn_text' );
$btn_url = bk_section( 'consulting', 'types', 'btn_url' );
?>

<section class="consulting-types" id="consulting-types"<?php echo $style; ?>>
