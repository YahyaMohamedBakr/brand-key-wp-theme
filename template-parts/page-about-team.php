 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'about', 'team' ) ) return;

$title = bk_section( 'about', 'team', 'title' );
$desc = bk_section( 'about', 'team', 'desc' );
$heading = bk_section( 'about', 'team', 'heading' ) ?: 'h2';
$bg = bk_section( 'about', 'team', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'about', 'team', 'btn_text' );
$btn_url = bk_section( 'about', 'team', 'btn_url' );
?>

<section class="about-team" id="about-team"<?php echo $style; ?>>
