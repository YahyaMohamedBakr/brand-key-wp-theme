 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'contact', 'form' ) ) return;

$title = bk_section( 'contact', 'form', 'title' );
$desc = bk_section( 'contact', 'form', 'desc' );
$heading = bk_section( 'contact', 'form', 'heading' ) ?: 'h2';
$bg = bk_section( 'contact', 'form', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'contact', 'form', 'btn_text' );
$btn_url = bk_section( 'contact', 'form', 'btn_url' );
?>

<section class="contact-form" id="contact-form"<?php echo $style; ?>>
