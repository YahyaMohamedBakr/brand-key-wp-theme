<?php
/**
 * سيكشن: deliverables (consulting)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'consulting', 'deliverables' ) ) return;

$title = bk_section( 'consulting', 'deliverables', 'title' );
$desc = bk_section( 'consulting', 'deliverables', 'desc' );
$heading = bk_section( 'consulting', 'deliverables', 'heading' ) ?: 'h2';
$bg = bk_section( 'consulting', 'deliverables', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'consulting', 'deliverables', 'btn_text' );
$btn_url = bk_section( 'consulting', 'deliverables', 'btn_url' );
?>

<section class="consulting-deliverables" id="consulting-deliverables"<?php echo $style; ?>>
