<?php
/**
 * سيكشن: services (integration)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'integration', 'services' ) ) return;

$title = bk_section( 'integration', 'services', 'title' );
$desc = bk_section( 'integration', 'services', 'desc' );
$heading = bk_section( 'integration', 'services', 'heading' ) ?: 'h2';
$bg = bk_section( 'integration', 'services', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'integration', 'services', 'btn_text' );
$btn_url = bk_section( 'integration', 'services', 'btn_url' );
?>

<section class="integration-services" id="integration-services"<?php echo $style; ?>>
