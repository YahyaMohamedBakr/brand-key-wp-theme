 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'about', 'mission' ) ) return;

$title = bk_section( 'about', 'mission', 'title' );
$desc = bk_section( 'about', 'mission', 'desc' );
$heading = bk_section( 'about', 'mission', 'heading' ) ?: 'h2';
$bg = bk_section( 'about', 'mission', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'about', 'mission', 'btn_text' );
$btn_url = bk_section( 'about', 'mission', 'btn_url' );
?>

<section class="about-mission" id="about-mission"<?php echo $style; ?>>
