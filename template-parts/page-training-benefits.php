<?php
/**
 * سيكشن: benefits (training)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'training', 'benefits' ) ) return;

$title = bk_section( 'training', 'benefits', 'title' );
$desc = bk_section( 'training', 'benefits', 'desc' );
$heading = bk_section( 'training', 'benefits', 'heading' ) ?: 'h2';
$bg = bk_section( 'training', 'benefits', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'training', 'benefits', 'btn_text' );
$btn_url = bk_section( 'training', 'benefits', 'btn_url' );
?>

<section class="training-benefits" id="training-benefits"<?php echo $style; ?>>
  <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 90px 24px 80px;">

    <?php if ( 'benefits' === 'hero' ) : ?>
