<?php
/**
 * سيكشن: how (الصفحة الرئيسية)
 *
 * @package BrandKey
 */

// لو السيكشن مش مفعّل، اخرج
if ( ! bk_section_enabled( 'front_page', 'how' ) ) return;

// محتوى السيكشن من Customizer
$title = bk_section( 'front_page', 'how', 'title' );
$desc = bk_section( 'front_page', 'how', 'desc' );
$heading = bk_section( 'front_page', 'how', 'heading' ) ?: 'h2';
$bg = bk_section( 'front_page', 'how', 'bg' );
$dark = ! empty( $bg );
$line_icon = $dark ? 'line-white.png' : 'heading-line.png';
$btn_text = bk_section( 'front_page', 'how', 'btn_text' );
$btn_url = bk_section( 'front_page', 'how', 'btn_url' );
...
<section class="how" id="how"<?php echo $style; ?>>
  <div class="how-container">

    <?php if ( 'how' !== 'hero' ) : ?>
    <header class="how-head" id="howHead">
      <<?php echo esc_html( $heading ); ?> class="how-title" style="color: <?php echo esc_attr( $title_color ); ?>;"><?php echo esc_html( $title ); ?></<?php echo esc_html( $heading ); ?>>
      <img src="<?php echo esc_url( BK_URI . '/assets/icons/' . $line_icon ); ?>" alt="" class="heading-line how-heading-line" aria-hidden="true" />
      <p class="how-desc" style="color: <?php echo esc_attr( $desc_color ); ?>;"><?php echo esc_html( $desc ); ?></p>
    </header>
    <?php else : ?>
