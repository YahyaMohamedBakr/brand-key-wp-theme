<?php
/**
 * سيكشن: painpoints (consulting)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'consulting', 'painpoints' ) ) return;

$title = bk_section( 'consulting', 'painpoints', 'title' );
$desc = bk_section( 'consulting', 'painpoints', 'desc' );
$heading = bk_section( 'consulting', 'painpoints', 'heading' ) ?: 'h2';
$bg = bk_section( 'consulting', 'painpoints', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'consulting', 'painpoints', 'btn_text' );
$btn_url = bk_section( 'consulting', 'painpoints', 'btn_url' );
?>

<section class="consulting-painpoints" id="consulting-painpoints"<?php echo $style; ?>>
  <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 90px 24px 80px;">

    <?php if ( 'painpoints' === 'hero' ) : ?>
