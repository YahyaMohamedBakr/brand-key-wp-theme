<?php
/**
 * سيكشن: method (training)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'training', 'method' ) ) return;

$title = bk_section( 'training', 'method', 'title' );
$desc = bk_section( 'training', 'method', 'desc' );
$heading = bk_section( 'training', 'method', 'heading' ) ?: 'h2';
$bg = bk_section( 'training', 'method', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'training', 'method', 'btn_text' );
$btn_url = bk_section( 'training', 'method', 'btn_url' );
?>

<section class="training-method" id="training-method"<?php echo $style; ?>>
