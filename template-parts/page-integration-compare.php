<?php
/**
 * سيكشن: compare (integration)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'integration', 'compare' ) ) return;

$title = bk_section( 'integration', 'compare', 'title' );
$desc = bk_section( 'integration', 'compare', 'desc' );
$heading = bk_section( 'integration', 'compare', 'heading' ) ?: 'h2';
$bg = bk_section( 'integration', 'compare', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'integration', 'compare', 'btn_text' );
$btn_url = bk_section( 'integration', 'compare', 'btn_url' );
?>

<section class="integration-compare" id="integration-compare"<?php echo $style; ?>>
