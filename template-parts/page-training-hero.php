 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'training', 'hero' ) ) return;

$title = bk_section( 'training', 'hero', 'title' );
$desc = bk_section( 'training', 'hero', 'desc' );
$heading = bk_section( 'training', 'hero', 'heading' ) ?: 'h2';
$bg = bk_section( 'training', 'hero', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'training', 'hero', 'btn_text' );
$btn_url = bk_section( 'training', 'hero', 'btn_url' );
?>

<section class="training-hero" id="training-hero"<?php echo $style; ?>>
