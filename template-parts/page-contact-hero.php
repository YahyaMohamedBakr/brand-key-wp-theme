 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'contact', 'hero' ) ) return;

$title = bk_section( 'contact', 'hero', 'title' );
$desc = bk_section( 'contact', 'hero', 'desc' );
$heading = bk_section( 'contact', 'hero', 'heading' ) ?: 'h2';
$bg = bk_section( 'contact', 'hero', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'contact', 'hero', 'btn_text' );
$btn_url = bk_section( 'contact', 'hero', 'btn_url' );
?>

<section class="contact-hero" id="contact-hero"<?php echo $style; ?>>
