<?php
/**
 * سيكشن: security (about)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'about', 'security' ) ) return;

$title = bk_section( 'about', 'security', 'title' );
$desc = bk_section( 'about', 'security', 'desc' );
$heading = bk_section( 'about', 'security', 'heading' ) ?: 'h2';
$bg = bk_section( 'about', 'security', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'about', 'security', 'btn_text' );
$btn_url = bk_section( 'about', 'security', 'btn_url' );
?>

<section class="about-security" id="about-security"<?php echo $style; ?>>
  <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 90px 24px 80px;">

    <?php if ( 'security' === 'hero' ) : ?>
