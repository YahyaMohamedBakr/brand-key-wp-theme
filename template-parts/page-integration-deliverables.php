<?php
/**
 * سيكشن: deliverables (integration)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'integration', 'deliverables' ) ) return;

$title = bk_section( 'integration', 'deliverables', 'title' );
$desc = bk_section( 'integration', 'deliverables', 'desc' );
$heading = bk_section( 'integration', 'deliverables', 'heading' ) ?: 'h2';
$bg = bk_section( 'integration', 'deliverables', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'integration', 'deliverables', 'btn_text' );
$btn_url = bk_section( 'integration', 'deliverables', 'btn_url' );
?>

<section class="integration-deliverables" id="integration-deliverables"<?php echo $style; ?>>
  <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 90px 24px 80px;">

    <?php if ( 'deliverables' === 'hero' ) : ?>
