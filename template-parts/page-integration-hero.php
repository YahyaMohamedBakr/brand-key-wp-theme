<?php
/**
 * سيكشن: hero (integration)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'integration', 'hero' ) ) return;

$title = bk_section( 'integration', 'hero', 'title' );
$desc = bk_section( 'integration', 'hero', 'desc' );
$heading = bk_section( 'integration', 'hero', 'heading' ) ?: 'h2';
$bg = bk_section( 'integration', 'hero', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'integration', 'hero', 'btn_text' );
$btn_url = bk_section( 'integration', 'hero', 'btn_url' );
?>

<section class="integration-hero" id="integration-hero"<?php echo $style; ?>>
