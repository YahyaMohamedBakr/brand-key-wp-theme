 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'about', 'vision' ) ) return;

$title = bk_section( 'about', 'vision', 'title' );
$desc = bk_section( 'about', 'vision', 'desc' );
$heading = bk_section( 'about', 'vision', 'heading' ) ?: 'h2';
$bg = bk_section( 'about', 'vision', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'about', 'vision', 'btn_text' );
$btn_url = bk_section( 'about', 'vision', 'btn_url' );
?>

<section class="about-vision" id="about-vision"<?php echo $style; ?>>
