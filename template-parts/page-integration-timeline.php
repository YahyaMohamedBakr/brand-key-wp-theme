<?php
/**
 * سيكشن: timeline (integration)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'integration', 'timeline' ) ) return;

$title = bk_section( 'integration', 'timeline', 'title' );
$desc = bk_section( 'integration', 'timeline', 'desc' );
$heading = bk_section( 'integration', 'timeline', 'heading' ) ?: 'h2';
$bg = bk_section( 'integration', 'timeline', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'integration', 'timeline', 'btn_text' );
$btn_url = bk_section( 'integration', 'timeline', 'btn_url' );
?>

<section class="integration-timeline" id="integration-timeline"<?php echo $style; ?>>
  <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 90px 24px 80px;">

    <?php if ( 'timeline' === 'hero' ) : ?>
