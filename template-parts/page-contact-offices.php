<?php
/**
 * سيكشن: offices (contact)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'contact', 'offices' ) ) return;

$title = bk_section( 'contact', 'offices', 'title' );
$desc = bk_section( 'contact', 'offices', 'desc' );
$heading = bk_section( 'contact', 'offices', 'heading' ) ?: 'h2';
$bg = bk_section( 'contact', 'offices', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'contact', 'offices', 'btn_text' );
$btn_url = bk_section( 'contact', 'offices', 'btn_url' );
?>

<section class="contact-offices" id="contact-offices"<?php echo $style; ?>>
