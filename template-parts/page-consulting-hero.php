<?php
/**
 * سيكشن: hero (consulting)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'consulting', 'hero' ) ) return;

$title = bk_section( 'consulting', 'hero', 'title' );
$desc = bk_section( 'consulting', 'hero', 'desc' );
$heading = bk_section( 'consulting', 'hero', 'heading' ) ?: 'h2';
$bg = bk_section( 'consulting', 'hero', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'consulting', 'hero', 'btn_text' );
$btn_url = bk_section( 'consulting', 'hero', 'btn_url' );
?>

<section class="consulting-hero" id="consulting-hero"<?php echo $style; ?>>
