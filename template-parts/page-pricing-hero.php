 ...
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'pricing', 'hero' ) ) return;

$title = bk_section( 'pricing', 'hero', 'title' );
$desc = bk_section( 'pricing', 'hero', 'desc' );
$heading = bk_section( 'pricing', 'hero', 'heading' ) ?: 'h2';
$bg = bk_section( 'pricing', 'hero', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'pricing', 'hero', 'btn_text' );
$btn_url = bk_section( 'pricing', 'hero', 'btn_url' );
?>

<section class="pricing-hero" id="pricing-hero"<?php echo $style; ?>>
