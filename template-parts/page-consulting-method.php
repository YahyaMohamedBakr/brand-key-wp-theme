<?php
/**
 * سيكشن: method (consulting)
 * @package BrandKey
 */
if ( ! bk_section_enabled( 'consulting', 'method' ) ) return;

$title = bk_section( 'consulting', 'method', 'title' );
$desc = bk_section( 'consulting', 'method', 'desc' );
$heading = bk_section( 'consulting', 'method', 'heading' ) ?: 'h2';
$bg = bk_section( 'consulting', 'method', 'bg' );
$dark = ! empty( $bg );
...
$btn_text = bk_section( 'consulting', 'method', 'btn_text' );
$btn_url = bk_section( 'consulting', 'method', 'btn_url' );
?>

<section class="consulting-method" id="consulting-method"<?php echo $style; ?>>
